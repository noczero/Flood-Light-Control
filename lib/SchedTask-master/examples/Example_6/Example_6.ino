...
Change Log
	...
	09/30/2020 18:02 removed SoftwareSerial
*/
...
void setup() {
	...
	schedArr[1] = &Task6;											// init array element 1 to point to a SchedTask
}
...
// pBase is of Type pointer to SchedBase, but it actually points to the SchedTaskT object
	reinterpret_cast<SchedTaskT<SchedBase*>*>(pBase)->setFuncT(&task5); // note: setFuncT, not setFunc
	reinterpret_cast<SchedTaskTptr>(pBase)->getFuncT();		// note: getFuncT, not get Func
}
